...
class Cube3DVCWithPerformance: UIViewController {
    ...
    func render() {
        ...
        objectToDraw.renderWithPerform(commandQueue: commandQueue, pipelineState: pipelineState, drawable: drawable, parentModelViewMatrix: worldModelMatrix, projectionMatrix: projectionMatrix ,clearColor: nil)
    }
}
